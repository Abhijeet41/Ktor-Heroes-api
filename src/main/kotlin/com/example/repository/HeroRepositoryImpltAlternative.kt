...
class HeroRepositoryImpltAlternative : HeroRepositoryAlterNative {
    ...
    private fun calculatePage(
        ...
        require(page <= allHeroes.size)//this fun will throw exception if boolean value return false
    ...
    private fun findHeroes(nameQuery: String?): List<Hero> {
        var founded = mutableListOf<Hero>()
